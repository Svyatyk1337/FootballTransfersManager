        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentClubId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Players_Agents_AgentId",
                        column: x => x.AgentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromClubId = table.Column<int>(type: "integer", nullable: true),
                    ToClubId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ContractLength = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
